          ...
          >
            ...
            <div className="flex items-center justify-between px-[14px] py-[9px] border-b border-[#f0f2f5]">
              <div className="flex items-center gap-[4px]">
                <svg width="15" height="15" viewBox="0 0 512 512" fill="#374957">
            ...
            <div className="px-[14px] py-[14px]">
              <div className="flex items-center">
                ...
                <div className="flex flex-col items-center px-[12px]">
                  <div className="bg-[#374957] rounded-md px-[10px] py-[4px] flex items-center gap-[2px]">
                    <svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                      <circle cx="12" cy="12" r="10" />
                      <path d="M12 6v6l4 2" />
                    </svg>
                    <span className="text-[14px] font-bold text-white leading-none ml-[3px]">{match.time}</span>
                  </div>
                  <span className="text-[10px] text-[#737B8C] font-semibold mt-[5px]">{match.date}</span>
                </div>
